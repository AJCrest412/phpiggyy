...
class Router
{
  ...
  public function dispatch(string $path, string $method, Container $container = null)
  {
    ...
    foreach ($this->routes as $route) {
      ...
      $allMiddleware = array_merge($route['middlewares'], $this->middlewares);
  ...
  public function dispatchNotFound(?Container $container)
  {
    ...
    $controllerInstace = $container ? $container->resolve($class) : new $class;

    $action = fn () => $controllerInstace->$function();
